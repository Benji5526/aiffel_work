...
`POST /api/fortune`, `GET /api/cities`, `GET /api/health` 세 개의 엔드포인트가 있습니다. 요청/응답 필드, 사주 계산 로직(진태양시 보정 공식, 십성 분류 방식 등), 도시 경도 테이블의 제한사항은 **[오늘의운세/API.md](./오늘의운세/API.md)** 에 상세히 정리되어 있습니다.
